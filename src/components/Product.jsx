...
const Product = ({post}) => {
    ...
    return (
        ...
        duration-300 ease-in hover:shadow-[rgba(0,_0,_0,_0.4)_0px_30px_90px] gap-3 p-4 mt-10 ml-5 rounded-xl group h-[380px] hover:bg-slate-900">
            ...
            <div>
                <p className="text-gray-700 font-semibold text-lg text-left truncate w-40 mt-1 group-hover:text-gray-300">{post.title}</p>
            </div>
